    ...
    public static class GetAllMonthlyBudgets
    {
            ...
            ILogger log)
        {
            try {
                ...
                log.LogInformation("C# HTTP trigger function processed a request on GetAllMonthlyBudgets.");
                ...
                return new OkObjectResult(monthlyBudgets);
            }
