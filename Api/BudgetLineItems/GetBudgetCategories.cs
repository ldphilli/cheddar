...
namespace Cheddar.Function {
    public static class GetBudgetCategories {
        ...
        public static async Task<IActionResult> Run(
            ...
            try {
                List<IBudgetCategoriesModel> allBudgetCategoriesForUser = new List<IBudgetCategoriesModel>();
                ...
                while (streamResultSet.HasMoreResults) {
                    using (ResponseMessage responseMessage = await streamResultSet.ReadNextAsync()) {
                        ...
                        if (responseMessage.IsSuccessStatusCode) {
                            ...
                            List<IBudgetCategoriesModel> budgetCategories = streamResponse.Documents.ToObject<List<IBudgetCategoriesModel>>();
